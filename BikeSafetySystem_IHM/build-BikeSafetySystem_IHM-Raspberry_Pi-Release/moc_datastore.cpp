...
#include "../BikeSafetySystem_IHM/datastore.h"
...
void DataStore::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeOfStatus((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (DataStore::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DataStore::changeOfStatus)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->getTheChange(); break;
        default: break;
        }
...
// SIGNAL 0
void DataStore::changeOfStatus(int _t1)
{
